...
Ce sera un livrable → vous devrez exporter la VM en OVA. Utilisateur qui fait partie des sudoers :  rezo avec mdp rezo
...
./failed_login.sh auth.log ./top_ip.sh auth.log 10 ./compare_jours.sh auth_jour1.log auth_jour2.log ./menu.sh
...
Présentation des logs fournis

Scripts développés + commandes clés utilisées

Résultats et extraits de sortie
...
Phase	Durée
Démonstration live des scripts sur VM Debian	7 min
Explication d’un script tiré au sort par l’enseignant	6 min
Transition / installation du groupe suivant	2 min
...
GitHub Codespaces Debian	Arrive bientôt — sera ajouté en section complémentaire
